...
MEF and ESC scRNA-seq data             & GEO Accession: GSE103221 & \begin{tabular}[c]{@{}l@{}}Samples with label start with 'mef' as MEF\\ Samples with label start with 'esc' as ESC\end{tabular} \\ \hline
